...
abstract class GameRunner {
    ...
    private String getNextPlayerOutput(NextPlayerInfo nextPlayerInfo, String nextPlayerInput) {
        ...
        Referee.LogQueue.add(LocalDateTime.now().toLocalTime() + ": runner.GameRunner.getNextPlayerOutput: start measurement");
        ...
        Referee.LogQueue.add(LocalDateTime.now().toLocalTime() + ": runner.GameRunner.getNextPlayerOutput: end measurement - " + player.lastExecutionTimeMs + " ms");
