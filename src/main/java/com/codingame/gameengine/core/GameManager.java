...
abstract public class GameManager<T extends AbstractPlayer> {
    ...
    private static final int GAME_SUMMARY_TOTAL_HARD_QUOTA = 512 * 10240;
    private static final int GAME_SUMMARY_PER_TURN_HARD_QUOTA = 8000;
    ...
    private void dumpNextPlayerInput(String[] input) {
        ...
        data.addAll(input);
        Referee.LogQueue.add(LocalDateTime.now().toLocalTime() + ": core.GameManager: dumpNextPlayerInput");
        out.println(data);
